...
// do steps 3 and 4.
export const MACHINE_PIN_SCROLL_DISTANCE = 10000;
...
export const MACHINE_PHASES = {
  ...
  plateFull: 0.101,
  wordOut: 0.101,
  zoomStart: 0.101, // the plate starts growing the moment the wordmark starts leaving
  zoomEnd: 0.26, // by here we're through the hatch
  ...
  cardEnd: 0.4176, // and has been flown all the way to full size by here
} as const;
